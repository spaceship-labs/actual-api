  ...
  nativeUpdateOne: function(findCriteria, params, model) {
    return new Promise(function(resolve, reject) {
      model.native(function(err, collection) {
        ...
        collection.updateOne(findCriteria, updateParams, function(
          errUpdate,
          result
        ) {
          if (errUpdate) {
  ...
  nativeUpdate: function(findCriteria, params, model) {
    return new Promise(function(resolve, reject) {
      model.native(function(err, collection) {
        ...
        collection.update(findCriteria, updateParams, { multi: true }, function(
          errUpdate,
          result
        ) {
          if (errUpdate) {
      ...
      .then(function(orders) {
        ...
        return Promise.each(orders, function(order) {
          if (order.Quotation) {
            ...
            console.log(
              'updating order:' + order.id + ' with:' + updateParams.createdAt
            );
