...
module.exports = {
  ...
  attributes: {
    ...
    actual_bussiness_cancun: { type: 'integer' },
    actual_bussiness_merida: { type: 'integer' },
    ...
    discountPrice_actual_bussiness_cancun: { type: 'float' },
    discountPrice_actual_bussiness_merida: { type: 'float' },
