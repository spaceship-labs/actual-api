...
module.exports = {
  ...
  attributes: {
    ...
    OnHand: { type: 'number', columnType: 'float' },
    IsCommited: { type: 'number', columnType: 'float' },
    OnOrder: { type: 'number', columnType: 'float' },
    Available: { type: 'number', columnType: 'float' },
    ...
    U_pctPuntos: { type: 'number', columnType: 'float' },
    ...
    DiscountPrice: { type: 'number', columnType: 'float' },
    ...
    ChairBackHeight: { type: 'number', columnType: 'float' },
    ChairBackHeightUnitMsr: { type: 'string' },
    SeatHeight: { type: 'number', columnType: 'float' },
    SeatHeightUnitMsr: { type: 'string' },
    ArmRestHeight: { type: 'number', columnType: 'float' },
    ArmRestHeightUnitMsr: { type: 'string' },
    Depth: { type: 'number', columnType: 'float' },
    ...
    discountPrice_actual_studio_merida: { type: 'number', columnType: 'float' },
    discountPrice_actual_studio_malecon: { type: 'number', columnType: 'float' },
    discountPrice_actual_studio_playa_del_carmen: { type: 'number', columnType: 'float' },
    discountPrice_actual_studio_cumbres: { type: 'number', columnType: 'float' },
    discountPrice_actual_isla_merida: { type: 'number', columnType: 'float' },
    discountPrice_actual_atelier: { type: 'number', columnType: 'float' },
    discountPrice_actual_home_xcaret: { type: 'number', columnType: 'float' },
    discountPrice_actual_home_merida: { type: 'number', columnType: 'float' },
    discountPrice_proyectos: { type: 'number', columnType: 'float' },
    discountPrice_actual_proyect: { type: 'number', columnType: 'float' },
    discountPrice_actual_marketplace: { type: 'number', columnType: 'float' },
